...
public class JobApp {
    ...
    public static void main(String[] args) {
        ...
        printParameters(person1, tester.displayResponsibilities(), tester.getSalary());
        printParameters(person2, businessAnalyst.displayResponsibilities(), businessAnalyst.getSalary());
    }
